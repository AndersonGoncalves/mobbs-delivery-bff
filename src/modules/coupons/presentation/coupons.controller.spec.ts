...
// requireOperatorRole (specs/0021-papeis-operador, mesclado depois desta spec ser escrita —
// mesmo padrão de orders.controller.spec.ts) — pula os três e injeta `req.restaurantId`.
